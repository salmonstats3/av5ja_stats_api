...
export class GameWebTokenBadRequest {
...
export class GameWebTokenNoResources {
  @ApiProperty({ default: 9402 })
  status: number;
...
export class GameWebTokenInvalidToken {
...
export class GameWebTokenUnauthorized {
  @ApiProperty({ default: 9406 })
  status: number;
...
export class GameWebTokenUpgradeRequired {
...
export class GameWebTokenResult {
  @ApiProperty({
    example:
