...
import { EventType } from "src/api/enum/event_type";
import { Mode } from "src/api/enum/mode";
import { Species } from "src/api/enum/species";
import { WaterLevel } from "src/api/enum/water_level";
