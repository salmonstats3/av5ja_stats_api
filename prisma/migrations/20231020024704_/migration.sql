...
CREATE TABLE "results" (
    ...
    CONSTRAINT "results_pkey" PRIMARY KEY ("play_time","uuid")
);
...
-- AddForeignKey
ALTER TABLE "players" ADD CONSTRAINT "players_play_time_uuid_fkey" FOREIGN KEY ("play_time", "uuid") REFERENCES "results"("play_time", "uuid") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "waves" ADD CONSTRAINT "waves_play_time_uuid_fkey" FOREIGN KEY ("play_time", "uuid") REFERENCES "results"("play_time", "uuid") ON DELETE CASCADE ON UPDATE CASCADE;
